...
class MDCBModule(nn.Module):
    def __init__(self, in_channels, out_channels):
        super(MDCBModule, self).__init__()

        self.conv1x1 = nn.Conv2d(in_channels, out_channels, kernel_size=1)

        self.conv3x3_1 = nn.Conv2d(out_channels, out_channels, kernel_size=3, padding=1)
        self.conv3x3_2 = nn.Conv2d(out_channels, out_channels, kernel_size=3, padding=1)
        self.conv3x3_3 = nn.Conv2d(out_channels, out_channels, kernel_size=3, padding=1)

        self.relu = nn.ReLU(inplace=True)

        self.conv_fusion = nn.Conv2d(out_channels * 4, out_channels, kernel_size=1)
